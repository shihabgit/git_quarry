...
$config['user_expire']                = 172800; //86500;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['error_start_delimiter']   = '<div class="dialog-box-container"><span class="dialog-box-border">';		// Error mesage start delimiter
$config['error_end_delimiter']     = '</span></div>';	// Error mesage end delimiter
