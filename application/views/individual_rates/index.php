<?php $this->load->view('individual_rates/pop_edit'); ?>
...
<div class="dv-top-content" align="center">
   <?php echo form_open("individual_rates", array('id' => 'searchForm')); ?>
               ...
               <div class="sec_container">
                  ...
                  <table class="sec_table">
                     ...
                     <tr>
                        <th>Party</th>
                        <td>
                           <select name="pty_id" id="pty_id" onchange="resetOptions(this, 'pdst_id', 'party_destinations/getDestinationsByParty', beforeAjax2, afterAjax2);" >
                     ...
                     <tr>
                        <th>Destination</th>
                        <td>
                           <select name="pdst_id" id="pdst_id">
                              <?php echo get_options2($destinations, ifSet2('pdst_id'), true, '--- Select ---'); ?>
                           </select>
                           <div class="ajaxLoader_pdst"> 
                              <img src="images/ajax-loader2.gif"> 
                              <img src="images/ajax-loader2.gif">
                           </div>  
                        </td>
...
<div class="dv-bottom-content">
   <div class="search-header">
      <div id="right_pan">
         ...
         <a href="<?php echo site_url('individual_rates/add'); ?>" >
         ...
         foreach ($table as $row)
         {
            ...
            <td>
               ...
               <div class="tile scroll-pane blackScroll">
                  ...
                  <?php $this->load->view('individual_rates/index_indv'); ?>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      $('.tile .indv_edit').click(function() {
         ...
         var pdst_name = $(this).closest('.indv_tr').find('.party_name').val();

         var indv_ids = [];

         //build an array of ids.
         $(this).closest('.indv_tr').find('.indv_id').each(function(i, obj) {
            indv_ids[i] = $(obj).val();
         });


         //Initializing popup box.
         init_pop_individual_rates_edit();

         $('#pop_individual_rates_edit .titleColumn').html('EDIT UNIT RATES OF "'+itm_name+'"');

         $('#pop_individual_rates_edit .namespan_box .namespan').text(pdst_name);
         
         $.post(site_url + 'individual_rates/beforeEdit', {indv_ids: indv_ids}, function(data) {

            $("#pop_individual_rates_edit .tbl_container").html(data);

            //Loading popupBox.
            loadPopup('pop_individual_rates_edit');
      ...
      $('.tile .indv_delete').click(function() {
         ...
         var msg = "Do you want to delete the all purchase/selling rates of '"+itm_name+"' for " + pdst_name;
         if (!confirm(msg))
            return;

         //Setting input.
         var inputs = {indv_ids: indv_ids}; // eg: {parent_id: parent_id, status: 1}

         // Disabling whole page background till Ajax respond.
         $.blockUI(); // Function is defined at "plugins/blockui-master/jquery.blockUI.js"

         $.post(site_url + "individual_rates/delete", inputs, function(result) {
