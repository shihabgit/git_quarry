...
<div class="dv-top-content" align="center">
        ...
        <tr>
            <td>
                ...
                <ul class="main_container" style="width: 50%;height: 370px;"> 
                    ...
                    <li>
                        ...
                        <div class="sec_container">
                            ...
                            <table class="sec_table">
                                ...
                                <tr>
                                    <th>Ownership</th>
                                    <td><input type="radio" name="workcentres[wcntr_ownership]" value="1" <?php echo ifSetRadioGroupArray('workcentres', 'wcntr_ownership', 1, TRUE) ?>  />
                                        <span class="multy_options">Owned</span>

                                        <input type="radio" name="workcentres[wcntr_ownership]" value="2" <?php echo ifSetRadioGroupArray('workcentres', 'wcntr_ownership', 2) ?> />
                                ...
                                <tr>
                                    <th>Capital</th>
                                    <td>
                                        <input type="text" class="intOnly" name="workcentres[wcntr_capital]" value="<?php echo set_value('workcentres[wcntr_capital]') ?>" >
                                ...
                                <tr>
                                    <th>Name</th>
                                    <td>
                                        <input type="text" name="workcentres[wcntr_name]" value="<?php echo set_value('workcentres[wcntr_name]') ?>" >
                                    ...
                                    <td>
                                        <div style="padding:0;float: left;">
                                            <select name="workcentres[wcntr_fk_workcentre_registration_details]" class="reg_id" >
                                                <?php echo get_options2($registrations, ifSet2("workcentres[wcntr_fk_workcentre_registration_details]"), true, '--- select ---'); ?>
                                            </select>
                                        </div>
                                        <div style="padding:1% 0 0 5px ;float: right;">
                                            <img src="images/add.png" id="addReg" title="Add New Reg.details">
                                        </div>
                    ...
                    <?php
                    $style = ifSetRadioGroupArray('workcentres', 'wcntr_ownership', 1, TRUE) ? "pointer-events: none; opacity: 0.6" : '';
                    ?>
                        ...
                        <div class="sec_container">
                            ...
                            <table class="sec_table">
                                    ...
                                    <td>
                                        <div style="padding:0;float: left;">
                                            <select name="rental_details[rntdt_fk_owners]" id="rntdt_fk_owners">
                                                <?php echo get_options2($owners, ifSetArray('rental_details', 'rntdt_fk_owners'), true, '--- Select ---'); ?>
                                            </select>
                                        </div>
                                        <div style="padding:1% 0 0 0 ;float: right;">
                                ...
                                <tr>
                                    <th>Advance Paid:</th>
                                    <td>
                                        <input type="text" class="intOnly" name="rental_details[rntdt_advance]" value="<?php echo set_value('rental_details[rntdt_advance]') ?>" >
                                ...
                                <tr>
                                    <th>Old Balance:</th>
                                    <td>
                                        <input type="text" class="intOnly" name="rental_details[rntdt_ob]" value="<?php echo set_value('rental_details[rntdt_ob]') ?>" >
                                        <?php echo form_error('rental_details[rntdt_ob]'); ?><br>


                                        <input type="radio" name="rental_details[rntdt_ob_mode]" value="1" <?php echo ifSetRadioGroupArray('rental_details', 'rntdt_ob_mode', 1) ?>  />
                                        <span class="multy_options">Cr.</span>

                                        <input type="radio" name="rental_details[rntdt_ob_mode]" value="2" <?php echo ifSetRadioGroupArray('rental_details', 'rntdt_ob_mode', 2, TRUE) ?>/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" style="width:110px;" class="intOnly" name="rental_details[rntdt_instalment_amount]" value="<?php echo set_value('rental_details[rntdt_instalment_amount]') ?>" >


                                        <input title="Rent automatically added to rent account when period reaches." type="checkbox" name="rental_details[rntdt_auto_add]" value="1" <?php echo set_checkbox('rental_details[rntdt_auto_add]', '1'); ?> />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="rental_details[rntdt_instalment_period]" value="1" <?php echo ifSetRadioGroupArray('rental_details', 'rntdt_instalment_period', 1) ?>  />
                                        <span class="multy_options">Daily</span>

                                        <input type="radio" name="rental_details[rntdt_instalment_period]" value="2" <?php echo ifSetRadioGroupArray('rental_details', 'rntdt_instalment_period', 2, TRUE) ?>/>
                                        <span class="multy_options">Monthly</span>

                                        <input type="radio" name="rental_details[rntdt_instalment_period]" value="3" <?php echo ifSetRadioGroupArray('rental_details', 'rntdt_instalment_period', 3) ?>  />
                                    ...
                                    <td>
                                        <div class="dateContainer" style="padding: 0px;margin:0px;">
                                            <div style="margin-right: 2px;float: left;" >
                                                <input class="dateField inputDate" readonly="" type="text" name="rental_details[rntdt_start_from]" value="<?php echo set_value('rental_details[rntdt_start_from]') ?>" style="width:110px" />
    ...
    <div id="submit_container">
        <hr /><br />
        <input type="hidden" name="workcentres[wcntr_status]" value="1" >   <!--  Setting Default Status As "Active"  -->
